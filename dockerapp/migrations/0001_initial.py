    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dockerfile', models.FileField(blank=True, upload_to='dockerfiles/%Y/%m/%d/%H-%M-%S')),
        ...
        migrations.AddField(
            model_name='containerbydockerfile',
            name='gitrepo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dockerapp.GitRepo'),
        ),
    ]
